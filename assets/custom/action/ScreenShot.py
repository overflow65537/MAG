"""
本文件代码完整源自项目 MAA_SnowBreak，作者：overflow65537
源码地址：https://github.com/overflow65537/MAA_SnowBreak/blob/main/assets/custom/action/ScreenShot.py
"""
...
class ScreenShot(CustomAction):
    def run(
        ...
        current_time = (
            param.get("type", "") + "_" + time.strftime("%Y-%m-%d_%H-%M-%S") + ".png"
        )
